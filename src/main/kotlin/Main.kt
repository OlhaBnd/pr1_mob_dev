fun main() {
    // Вхідні дані: за замовчуванням — можна змінити або вводити вручну
    // Приклад контролю (методичні дані):
    val ctrl = FuelData(
    ...
    // Можна також прочитати з консолі — тут для простоти виводимо два приклади
